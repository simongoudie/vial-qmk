...
LSFT(SE_SECT), SE_PIPE,LALT(KC_2),SE_LCBR,SE_RCBR, SE_QUES,                   LALT(KC_4), SE_ARNG,   SE_ADIA,SE_ODIA, LALT(SE_DIAE), XXXXXXX,
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, _______,     CUT,    COPY,   PASTE, _______,                      _______, RGB_TOG, _______, _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
___off___, ___off___, MG____RED, MG_ORANGE, MG__GREEN, ___off___,         ___off___, MG_ORANGE, ___off___, ___off___, ___off___, MG_PURPLE,
